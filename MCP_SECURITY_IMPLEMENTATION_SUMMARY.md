...
**Projects:** deposium_CLI + [private-server-repo]
...
## Part 2: MCP Server Authentication ([private-server-repo])
...
- **Repository:** [private-server-repo]
- **Commit:** `a37d959`
...
- [private-server-repo]: commit a37d959
