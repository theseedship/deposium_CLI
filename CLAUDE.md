...
Deposium CLI is an enterprise-grade command-line interface for the Deposium MCP (Model Context Protocol) API. It provides 23 operational commands for document search, knowledge graph operations, AI workflows, batch processing, dossier validation (validate command), and self-service management of spaces / documents / API keys.
